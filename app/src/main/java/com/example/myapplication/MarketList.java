...
//        adapter.notifyDataSetChanged();
    ...
    public void fetchimages()
    {
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, "https://noobistani.000webhostapp.com/DD%20app/getMarket.php", null, new Response.Listener<JSONArray>() {
            @Override
            public void onResponse(JSONArray response) {
                for(int i=0; i<response.length(); i++)
                {
                    try {
                        ...
                        Toast.makeText(MarketList.this, BaseURL+URL, Toast.LENGTH_SHORT).show();
